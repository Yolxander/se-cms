                ...
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-4 mb-5">
                        ...
                        <div class="card-body text-start p-4 w-100">
                            <h3 class="text-white mb-2">Manage Your Hotel Pages </h3>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Sections</th>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm font-weight-semibold">{{ $page->title }}</h6>
                                                        <p class="text-sm text-secondary mb-0">{{ $page->slug }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{ count($page->sections) }}</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm border border-success text-success bg-success">Published</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-sm font-weight-normal">{{ $page->updated_at->format('d/m/y') }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <a href="{{ route('site-pages.edit', $page->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit page">
